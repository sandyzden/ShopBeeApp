...
import materialtest.vivz.shop.adapters.BasicListAdapter;
...
public class InventoryActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupDrawer();
        Toast.makeText(this, "Welcome to the inventory", Toast.LENGTH_SHORT).show();
        setTitle("Inventory");

        // Following is the code changes for the cards materialList
    ...
    // Below are the methods for cards MaterialList
